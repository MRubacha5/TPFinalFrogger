...
froggerAllegro: mainAllegro.o AllegroSetup.o AllegroPause.o AllegroMainMenu.o AllegroIngame.o AllegroHiScore.o score.o world.o rana.o
	gcc -o froggerAllegro mainAllegro.o AllegroSetup.o AllegroPause.o AllegroMainMenu.o AllegroIngame.o AllegroHiScore.o score.o world.o rana.o $(AL_LIBS)
...
AllegroMainMenu.o: $(AL)/AllegroHiScore.c $(BC)/platformConfig.h $(AL)/AllegroSetup.h $(BC)/worldData.h $(BC)/rana.h
...
INCLUDES = -I./src/Backend -I./src/Frontend/Allegro -I./otra/carpeta